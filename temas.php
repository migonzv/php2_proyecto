...
<head>
  ...
  <body>
    <?php
      ...
      include "./menu.php";
      $sql = "SELECT id, titulo, contenido, autor, fecha, hora, categoria, pais FROM tema WHERE id = '$_GET[cual]' ";
      ...
      <form id = "form1" name = "form1" method = "post" action = "./agregar_respuesta.php">
        <table id="temas">
          ...
          <tr>
            ...
            <td><input type="text" name="autor" id="autor"></textarea> </td>
          <tr>
          <tr>
            <td><label for="pais">Pais:</label> </td>
            <td><input type="text" name="pais" id="pais"></textarea> </td>
          </tr>
          <tr>
            <td><label for="me_gusta">Me Gusta:</label> </td>
            <td><input type="text" name="me_gusta" id="me_gusta"></textarea> </td>
          </tr>
